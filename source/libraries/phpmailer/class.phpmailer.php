 ...
 */
  ...
  */
  ...
  public function CreateHeader() {
	...
	// I need to do a little magick here because From can only contain one address!
	$from = array();
	if(strpos($this->From, ',') !== false){
		list($frome,) = explode(',', $this->From);
		$from[0][0] = trim($frome);
	}
	else{
    ...
    if($this->Sender == '') {
      $result .= $this->HeaderLine('Return-Path', trim($from[0][0]));
    } else {
